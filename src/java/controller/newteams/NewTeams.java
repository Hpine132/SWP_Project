 ...
 * @author Admin
 */
@WebServlet(name="NewTeamsController", urlPatterns={"/trainer/newteams"})
public class NewTeams extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet NewTeamsController</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet NewTeamsController at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        session.setAttribute("classId", classId_raw);
