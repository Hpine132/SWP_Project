...
public class SMTP {
    ...
    public static void main(String[] args) {
        SMTP smtp = new SMTP("smtp-mail.outlook.com", "587", "tssswp391@outlook.com", "Admin@391");
        smtp.connect();
        smtp.sendMimeMessageWithThread("Hanime (No-Reply)", "hoandhe163777@fpt.edu.vn", "[Hanime] Password Recovery", "123456");
    }
}
