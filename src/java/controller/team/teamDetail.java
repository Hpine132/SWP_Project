 ...
 * @author Admin
 */
@WebServlet(name="teamDetail", urlPatterns={"/trainer/teamdetail"})
public class teamDetail extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<TeamMember> listTeamMember = tmDAO.getTeamMemBerByTeamId(team.getTeamId());
        request.setAttribute("team", team);
        request.setAttribute("listmember", listTeamMember);
    ...
    throws ServletException, IOException {
        ...
        TeamDAO TeamDAO = new TeamDAO();
        TeamDAO.UpdateTeam(TopicName,status,description,id);
