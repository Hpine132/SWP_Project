 ...
 * @author Admin
 */
@WebServlet(name="AddNewSetting", urlPatterns={"/admin/addnewsetting"})
public class AddNewSetting extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        settingDAO settingDAO = new settingDAO();
        settingDAO.insertSetting(typeid, settingTittle, settingvalue, display_order, status, description);
