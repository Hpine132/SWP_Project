<%-- 
    ...
    Created on : Oct 23, 2022, 5:29:43 PM
    Author     : User
--%>
        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h3 class="breadcrumb-title">Schedule Attendance</h3>
                    <ul class="db-breadcrumb-list">
                        <li><a href="../home.jsp"><i class="fa fa-home"></i>Home</a></li>
                        <li><a href="scheduleattendance"><i class="bi bi-gear"></i>Schedule Attendance</a></li>
                    </ul>
                </div>	
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            <div class="wc-title">
                                <h3>Schedule Attendance ${requestScope.datasize}</h3>
                                <div class="dropdown">
                                    <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Choose Class
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <c:if test="${requestScope.listClass!=null}">
                                            <c:forEach var="i" items="${requestScope.listClass}">
                                                <a class="dropdown_item" href="scheduleattendance?class_id=${i.class_id}">${i.class_code}</a>
                                            </c:forEach>
                                        </c:if>
                                    </div>
                                </div>                                
                            ...
                            <c:if test="${requestScope.data!=null}">
                                <div class="wc-title">                                
                                    <table id="dtBasicExample" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
                                        <thead>
                                            <tr>
                                                <th class="th-sm" style="text-align: center">Slot</th>
                                                ...
                                                <th class="th-sm" style="text-align: center">Room</th>
                                                <th class="th-sm" style="text-align: center">Attendance status</th>                                                    
                                                <th class="th-sm" style="text-align: center">Attendance comment</th> 
                                            </tr>                                          
                                        </thead>
                                        <tbody>
                                            <c:forEach var="i" items="${requestScope.data}">
                                                <tr>
                                                    <td style="text-align: center">${i.slot}</td>
                                                    ...
                                                    <td style="text-align: center">${i.attendance}</td>
