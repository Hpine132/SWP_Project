                        ...
                        <div class="widget-box">
                            <div class="wc-title">
                                ...
                                <div class="widget-inner">
                                    <form class="edit-profile m-b30" action="addnewsetting" method="post">                                    
                                        <div class="row">       
                                            <div class="form-group col-6">
                                                <label class="col-form-label">Tittle<label style="color: red">*</label></label>
                                                <div>
                                                    <input class="form-control" type="text" name="settingtittle">
                                                </div>
                                            </div>                                          
                                            <div class="form-group col-6">
                                            ...
                                            <div class="form-group col-6">
                                                <label class="col-form-label">Display order<label style="color: red">*</label></label>
                                                <div>
                                                    <input class="form-control" type="text" value="" pattern="[0-9.]{1,15}" name="display_order">
                                                </div>
                                            </div>
                                            <div class="form-group col-6">
                                                <label class="col-form-label">Setting value<label style="color: red">*</label></label>
                                                <div>
                                                    <input class="form-control" type="text" value="" pattern="[0-9.]{1,15}" name="settingvalue">
                                                </div>
                                            </div>
                                            <div class="form-group col-6">
