<%-- 
    Document   : login
    Created on : Sep 21, 2022, 7:20:40 PM
    Author     : Hungdaica
--%>
    ...
    <body id="bg">
                        ...
                        <form action="login" method="POST" class="contact-bx">
                            <div class="row placeani">
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="email" type="text" id="email" class="form-control" value="${uemail}" />
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <h5 style="color: red">${requestScope.msgErrorUsername}</h3>
                                </div>
                                <div class="col-lg-12">
        ...
        <script>
            if (document.getElementById("toast").value == 1) {
                toastr["success"]("Change password susscesfully, Login again");
            }
            toastr.options = {
                "closeButton": false,
                "debug": false,
