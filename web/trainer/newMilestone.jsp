        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                <div class="db-breadcrumb">
                    <h4 class="breadcrumb-title">New Milestone</h4>
                    ...
                    <div class="col-lg-12 m-b30">
                        <div class="widget-box">
                            ...
                            <div class="widget-inner">
                                <form class="edit-profile m-b30" action="newMilestone" method="post">                                    
                                    <div class="row">        
                                        <div class="form-group col-12">
                                            <label class="col-form-label" style="font-weight: bold">Tittle</label><label style="color: red">*</label>
                                            <div>
                                                <input class="form-control" name="title" required value="${requestScope.milestoneById.title}">                                                                                              
                                            </div>
                                        </div>
                                        <div class="form-group col-6" >
                                            <label class="col-form-label" style="font-weight: bold">Subject</label><label style="color: red">*</label>
                                            <select name="subject" onchange="load()" id="sub">
                                        ...
                                        <div class="form-group col-12">
                                            ...
                                            <div>
                                                <input type="radio" name="status" value="Open" checked required>Pending
                                                <input type="radio" name="status" value="In progress" required>In progress
